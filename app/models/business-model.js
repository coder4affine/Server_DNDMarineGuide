...
function getBusinesses(query) {
  return new Promise((resolve, reject) => {
    ...
    db.getConnection((error, conn) => {
      ...
      LEFT JOIN cat_codes
      ON cat_codes.bus_cat_cd = business.bus_cat_cd and cat_codes.bus_cat_cd = business.bus_cat_cd2 and cat_codes.bus_cat_cd = business.bus_cat_cd3  and cat_codes.bus_cat_cd = business.bus_cat_cd4 OR cat_codes.bus_cat_cd = business.bus_cat_cd5
      LEFT JOIN states
